...
<div style="max-width:700px;margin:20px auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.1);">
<div style="background:#1a2332;padding:20px 28px;">
<div style="color:#fff;font-size:18px;font-weight:700;">BML Transport & Consulting</div>
<div style="color:#8899aa;font-size:12px;margin-top:2px;">Коммерческое предложение</div>
</div>
<div style="padding:24px 28px;font-size:14px;line-height:1.7;color:#333;">
${greeting}<br><br>Направляю Вам ставки по интересующим направлениям:
${body}${cta}
</div>
<div style="border-top:1px solid #e8e8e8;padding:16px 28px;font-size:12px;color:#888;line-height:1.6;">${logoHtml}${sigHtml}</div>
</div></body></html>`;
}
